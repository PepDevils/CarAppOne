...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t.setTitle("Meu Toolbar");
        t.setSubtitle("Subtitulo");
        t.setLogo(R.mipmap.ic_launcher);
        t.findViewById(R.id.toolbar).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Clicast na toolbar", Toast.LENGTH_SHORT).show();
            }
        });
        //exemplo que vai buscar um menu, e estes tem icones(items)
        //ao clicar nesses icones abre uma web
